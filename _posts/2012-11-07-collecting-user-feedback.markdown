...
[![Telepathy and 5 Other Ways to Collect Actionable User Feedback](/wp-content/uploads/2012/11/telepathy.png)](/2012/11/07/collecting-user-feedback/)
...
In "[The Lean Startup](//theleanstartup.com/)," Eric Reis talks about the importance of measuring as a part of your product development cycle. Seeing how your users react to and interact with new features and ideas should influence your decisions about those features and ideas.
...
Your choice of those tools should be driven by the questions you're asking as well as the platform you're using. For example, Google Analytics is great for monitoring your general website performance, but KISSmetrics is a [more powerful tool](//www.kissmetrics.com/features/funnel) when it comes to optimizing the performance of your sales funnel.

**Here are some questions you may want to be asking and possible answers you can find in data:**

	1. **Q. Are there any confusing points in our product?** A. People spend more time on our transaction page than they should. Let's simplify the interface.
    2. **Q. Does this new copy perform better than the old one?** A. An A/B test shows higher conversion rates with the new copy. Great!
    3. **Q. Are these new social features making our product more engaging?** A. The number of Daily Active Users (DAU) went down for this cohort. Oh, shit!
...
But also remember that too much data is usually better than not enough data. This is why, for example, companies such as [Mint](//mint.com) start [investing heavily](//www.udemy.com/social-marketing) into data collection and analysis early on. You should too.
...
If you want to know why a user quit your service, ask her about that. Don't ask her if she is a cat or a dog person, because it probably won't be helpful. Don't ask for any information, unless you expect to see a [relationship](//en.wikipedia.org/wiki/Correlation_does_not_imply_causation) between that information and what you're researching.
...
[Google Forms](//drive.google.com), [Survey Monkey](//www.surveymonkey.com/), [Qualtrics](//www.qualtrics.com/), [Wufoo](//wufoo.ca/)… the list is endless. It all depends on how complex your survey is and how much money you feel like investing.

My faves are Google Forms for simple surveys and Qualtrics for the more advanced ones.


**Now let's look at an example.** Recently, I had to cancel my subscription to [DailyBurn](//dailyburn.com). It's a great service, but I couldn't justify paying for it, so I decided to quit.
...
![DailyBurn collects feedback through a quick survey](/wp-content/uploads/2012/11/Screen-Shot-2012-10-30-at-1.05.30-AM.png)
...
**Tools such as [UserVoice](//uservoice.com) and [GetSatisfaction](//getsatisfaction.com) allow users to leave their ideas, questions and suggestions and vote on the ones posted by others.**
...
[![HootSuite collects feedback using UserVoice](/wp-content/uploads/2012/11/Screen-Shot-2012-11-06-at-1.36.11-PM.png)](//feedback.hootsuite.com/forums/40182-hootsuite-com-web-dashboard/status/224928)

[HootSuite](//hootsuite.com) is known for using UserVoice to find the most demanded features for their products. They later implement those features if possible, which makes customers not only feel happy but also feel a sense of ownership of the product.

For instance, when I was driving the bus on the [HootSuite Translation Project](//translate.hootsuite.com/) back in 2011, we asked our international users to suggest which languages should the product be localized into. The most popular ones would be then added into the system.
